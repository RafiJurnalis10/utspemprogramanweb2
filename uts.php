...
<table border="1">
    <tr>
    <p>Tanggal Transaksi : 07 November 2023<?php $tanggal_default = date("Y-m-d");?></p>
    <p>Produk</p>
    <p>Pepsodent (2X10.000)</p>
    <p>Rinso (3X20.000)</p>
    <p>dove (2X22.000)
    <p>Total Pembelian: <?php echo number_format($totalpembelian, 0, ',', '.') ?> </p>
    <p>Diskon: <?php echo ($diskon * 200) ?>%</p>
